...
posterior_samples <- fit_mod2$draws("alpha",format = "df") %>% 
  as_tibble() %>% 
...
black_samples <- posterior_samples$alpha[posterior_samples$alpha == 1][1:n_posterior_samples]
other_samples <- posterior_samples$alpha[posterior_samples$alpha == 2][1:n_posterior_samples]
